   ...
   */
    ...
    onRequest: async function (client, message, args) {
        ...
        if(emoti <= 44 && emoti >= 23) {
           emoticon = ('https://cdn.discordapp.com/attachments/938786568175513660/970478360402743306/cok.png'); 
        } else if(emoti < 23 && emoti >= 12) {
            emoticon = ('https://cdn.discordapp.com/attachments/938786568175513660/970478360931213312/orta.png'); 
        } else if(emoti < 11) {
            emoticon = ('https://cdn.discordapp.com/attachments/1159948424565755986/1201207174882414814/az.png'); 
        }
...
Uyumlu musun? **${love}**`, files: [img]}).then(async (msg) => {
