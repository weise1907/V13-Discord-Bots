...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    let Row = new MessageActionRow().addComponents(
        ...
        .setStyle("SUCCESS")
        .setEmoji(message.guild.emojiGöster("weise_giveaway")),
        new MessageButton()
    ...
    await load.edit({
        components: [Row],
        content: `${message.guild.emojiGöster("weise_giveaway")} ${message.guild.emojiGöster("weise_giveaway")} **ÇEKİLİŞ** ${message.guild.emojiGöster("weise_giveaway")} ${message.guild.emojiGöster("weise_giveaway")}`,
        embeds: [
