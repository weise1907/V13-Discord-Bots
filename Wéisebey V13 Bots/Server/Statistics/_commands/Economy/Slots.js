...
let Kıbrısweise = [message.guild.emojiGöster("weise_pat"),message.guild.emojiGöster("weise_heart"),message.guild.emojiGöster("weise_vis")];
var SlotOne = Kıbrısweise[Math.floor(Math.random() * 3)]
var SlotTwo = Kıbrısweise[Math.floor(Math.random() * 3)]
var SlotThree = Kıbrısweise[Math.floor(Math.random() * 3)]
...
\`___SLOTS___\`
  ${message.guild.emojiGöster("weise_slot")} ${message.guild.emojiGöster("weise_slot")} ${message.guild.emojiGöster("weise_slot")}
\`|         |\`
\`|         |\`
